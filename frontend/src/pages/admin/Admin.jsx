...
import campusSchema  from './responseSchema';
    ...
    try {
      const response = await fetch(
        "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent",
        {
          ...
          headers: {
            "Content-Type": "application/json",
            "x-goog-api-key": "AIzaSyCD-C38_rjLuNxZFqQe5YGa2_ceBvNSxaE"
          },
          body: JSON.stringify({
            // structured output config
            generationConfig: {
              responseMimeType: "application/json",
              responseSchema: campusSchema // imported from './responseSchema.js'
            },
            contents: [
              {
                parts: [
      ...
      <div className="body">
        ...
        <div className="save-content-area">
          <div className="save-content-box">
            ...
            {docMode ? <Doc /> : <Faq topClass={topClass} setTopClass={setTopClass} content={content} setContent={setContent} submitData={submitData} callGeminiAPI={callGeminiAPI}/>}
          </div>
        </div>
